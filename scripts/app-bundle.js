...
define('profile-state',["require", "exports", "aurelia-router", "aurelia-framework", "./api/web-api-users", "./resources/constants"], function (require, exports, aurelia_router_1, aurelia_framework_1, web_api_users_1, Constants) {
    "use strict";
    var CV = Constants;
    var ProfileState = (function () {
        function ProfileState(api, router) {
            var _this = this;
            this.api = api;
            this.CV = CV;
            this.loggedInUser = null;
