...
define('api/web-api-users',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "aurelia-router", "jquery"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, aurelia_router_1) {
    ...
    var WebAPIUsers = (function () {
        ...
        WebAPIUsers.prototype.apiCall = function (getId, getData) {
            ...
            var apiUrl = !hw_useJson ? path_api + apiUrlsArr[getId].url : path_api + apiUrlsArr[getId].urlLocal;
...
define('text!views/widgets/inputs/form-input.html', ['module'], function(module) { module.exports = "<template class=\"${!inputOnly ? 'form-group col-xs-12' : ''} ${isMandatory && !isReadonly ? 'is-mandatory' : ''}\">\r\n    \r\n    <require from=\"aurelia-mask/masked-input\"></require>\r\n    <require from=\"../../../resources/format/format-date\"></require>\r\n\r\n    <label if.bind=\"!inputOnly\" class=\"col-xs-6\" for.bind=\"name\" title.bind=\"inpLabel\">\r\n        <!--<i if.bind=\"isReadonly\" class=\"fa fa-eye text-after\" title=\"Read Only\"></i>\r\n        <i if.bind=\"isMemberOnly\" class=\"fa fa-exclamation-triangle text-after\" title=\"Members Only\"></i>-->\r\n        ${inpLabel}\r\n    </label>\r\n    <div class=\"${!inputOnly ? 'col-xs-6' : ''}\">\r\n        <input if.bind=\"maskPattern=='telephone'\" type=\"inpType\" masked=\"value.bind: model; mask.bind: maskPatternTelephone\" class=\"form-control\" id.one-way=\"name\" placeholder.bind=\"inpPlaceholder\" readonly.bind=\"isReadonly || isReadOnly\">\r\n        <input if.bind=\"maskPattern=='telephone-cc'\" type=\"inpType\" masked=\"value.bind: model; mask.bind: maskPatternTelephoneCc\" class=\"form-control\" id.one-way=\"name\" placeholder.bind=\"inpPlaceholder\" readonly.bind=\"isReadonly || isReadOnly\">\r\n        <input if.bind=\"inpType=='date'\" type=\"inpType\" value.bind=\"model | formatDate\" class=\"form-control\" id.one-way=\"name\" placeholder.bind=\"inpPlaceholder\" readonly.bind=\"isReadonly || isReadOnly\">\r\n        <input if.bind=\"!maskPattern && inpType=='text'\" type=\"inpType\" value.bind=\"model\" class=\"form-control\" id.one-way=\"name\" placeholder.bind=\"inpPlaceholder\" readonly.bind=\"isReadonly || isReadOnly\">\r\n    </div>\r\n\r\n</template>"; });
