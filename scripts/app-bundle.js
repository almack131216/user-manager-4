...
define('app',["require", "exports", "aurelia-router", "aurelia-framework", "./resources/constants", "aurelia-auth", "./profile-state", "aurelia-http-client"], function (require, exports, aurelia_router_1, aurelia_framework_1, Constants, aurelia_auth_1, profile_state_1, aurelia_http_client_1) {
    "use strict";
    var CV = Constants;
    ...
    var App = (function () {
        ...
        App.prototype.activate = function () {
            ...
            return this.http.get(profileUrl)
                ...
                _this.repos = response.content,
                    _this.myProfile = response.content[0].currentUser,
                    _this.isMember = response.content[0].currentUser.isMember;
            });
        };
    ...
    App = __decorate([
        aurelia_framework_1.inject(aurelia_http_client_1.HttpClient, aurelia_router_1.Router, aurelia_auth_1.FetchConfig, profile_state_1.ProfileState),
...
define('views/pages/welcome',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../../resources/constants", "../../profile-state", "../../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, Constants, profile_state_1, web_api_users_1) {
    ...
    var Welcome = (function () {
        function Welcome(api, ea, myState) {
            this.api = api;
            this.ea = ea;
    ...
    Welcome = __decorate([
        ...
        __metadata("design:paramtypes", [web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, profile_state_1.ProfileState])
    ], Welcome);
...
define('profile-state',["require", "exports", "aurelia-router", "aurelia-framework", "./api/web-api-users", "./resources/constants", "aurelia-http-client"], function (require, exports, aurelia_router_1, aurelia_framework_1, web_api_users_1, Constants, aurelia_http_client_1) {
    "use strict";
    var CV = Constants;
    var profileUrl = 'src/api/api-global.json';
