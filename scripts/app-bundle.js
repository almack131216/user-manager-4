...
define('views/widgets/user-list',["require", "exports", "aurelia-event-aggregator", "../../api/web-api-users", "../../resources/messages", "aurelia-framework", "aurelia-framework", "../../resources/constants", "aurelia-dialog", "../../user-info/user-info", "../../dialog-demo/roles-dialog", "../../dialog-demo/add-user-dialog"], function (require, exports, aurelia_event_aggregator_1, web_api_users_1, messages_1, aurelia_framework_1, aurelia_framework_2, Constants, aurelia_dialog_1, user_info_1, roles_dialog_1, add_user_dialog_1) {
    "use strict";
    var CV = Constants;
    var UserList = (function () {
        ...
        UserList.prototype.created = function () {
            ...
            this.api.getUserList().then(function (users) { return _this.users = users; })
                .then(function () { return _this.populateRoleFilter(); });
        };
