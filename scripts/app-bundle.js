    ...
    var UserList = (function () {
        function UserList(api, ea, userInfo, dialogService, lookups, router) {
            ...
            this.api.getUserList()
                ...
                _this.filter_memberType = lookups.filter_memberType;
                _this.filter_active = lookups.filter_active;
                _this.filter_memberType = lookups.filter_memberType;
                _this.rolesArr = _this.filter_memberType.map(function (x) {
                    return {
                        value: x.value,
                        name: x.name
                    };
