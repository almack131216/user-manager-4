...
define('api/web-api-users',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "aurelia-router"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, aurelia_router_1) {
    ...
    var WebAPIUsers = (function () {
        ...
        WebAPIUsers.prototype.saveUserProfile = function (id, data) {
            ...
            return new Promise(function (resolve) {
                setTimeout(function () {
                    var savedData = _this.http.fetch(tmpUrl)
...
define('views/pages/user-add',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../../api/web-api-users", "aurelia-framework"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, web_api_users_1, aurelia_framework_2) {
    "use strict";
            ...
            return this.api.getUserDetails(params.id).then(function (user) {
                ...
                _this.profile = {
                    ...
                    confidentialData: _this.user['profile']['confidentialData'] ? {
                        ...
                        employmentStatus: {
                            value: _this.user['profile']['confidentialData']['employmentStatus'].value ? _this.user['profile']['confidentialData']['employmentStatus'].value : null,
                            name: _this.user['profile']['confidentialData']['employmentStatus'].name ? _this.user['profile']['confidentialData']['employmentStatus'].name : null
                        },
                        credentialLevel: {
                            value: _this.user['profile']['confidentialData']['credentialLevel'].value ? _this.user['profile']['confidentialData']['credentialLevel'].value : null,
                            name: _this.user['profile']['confidentialData']['credentialLevel'].name ? _this.user['profile']['confidentialData']['credentialLevel'].name : null
                        },
