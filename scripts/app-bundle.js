...
define('app',["require", "exports", "aurelia-router", "aurelia-framework", "./resources/constants", "aurelia-auth", "./profile-state", "./api/web-api-users", "aurelia-http-client"], function (require, exports, aurelia_router_1, aurelia_framework_1, Constants, aurelia_auth_1, profile_state_1, web_api_users_1, aurelia_http_client_1) {
    "use strict";
    var CV = Constants;
    ...
    App = __decorate([
        aurelia_framework_1.autoinject,
        aurelia_framework_1.inject(aurelia_http_client_1.HttpClient, aurelia_router_1.Router, aurelia_auth_1.FetchConfig, profile_state_1.ProfileState, web_api_users_1.WebAPIUsers),
...
define('views/pages/welcome',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../../resources/constants", "../../profile-state", "../../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, Constants, profile_state_1, web_api_users_1) {
    "use strict";
    var CV = Constants;
    var Welcome = (function () {
        function Welcome(myState) {
            this.CV = CV;
            this.title = '';
            this.myState = myState;
        }
        Welcome.prototype.created = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/];
                });
...
define('views/ui/nav-bar',["require", "exports", "aurelia-framework", "../../resources/constants", "aurelia-router", "aurelia-framework"], function (require, exports, aurelia_framework_1, Constants, aurelia_router_1, aurelia_framework_2) {
    "use strict";
    var CV = Constants;
    var NavBar = (function () {
        ...
        NavBar.inject = function () {
            return [aurelia_framework_2.Parent.of(aurelia_router_1.Router)];
        };
        ...
        Object.defineProperty(NavBar.prototype, "isLoggedIn", {
            get: function () {
                return true;
            },
            enumerable: true,
