...
define('views/widgets/user-list',["require", "exports", "aurelia-event-aggregator", "../../api/web-api-users", "../../resources/messages", "aurelia-framework", "aurelia-framework", "../../resources/constants", "aurelia-dialog", "../../user-info/user-info", "../../dialog-demo/info-dialog", "../../dialog-demo/roles-dialog"], function (require, exports, aurelia_event_aggregator_1, web_api_users_1, messages_1, aurelia_framework_1, aurelia_framework_2, Constants, aurelia_dialog_1, user_info_1, info_dialog_1, roles_dialog_1) {
    "use strict";
    var CV = Constants;
    var UserList = (function () {
        function UserList(api, ea, userInfo, dialogService) {
            var _this = this;
            this.api = api;
            this.userInfo = userInfo;
            this.dialogService = dialogService;
...
define('views/widgets/inputs/form-select',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    var FormSelect = (function () {
        ...
        FormSelect.prototype.created = function () {
            ...
            if (!this.inpLabel)
                this.inpLabel = this.tmpCreateLabel(this.name).substring(3);
            if (!this.inpPlaceholder)
                this.inpPlaceholder = "Enter " + this.inpLabel;
        };
...
define('dialog-demo/info-dialog.1',["require", "exports", "aurelia-framework", "aurelia-dialog"], function (require, exports, aurelia_framework_1, aurelia_dialog_1) {
    "use strict";
    var InfoDialog = (function () {
        function InfoDialog(controller) {
            this.controller = controller;
...
define('dialog-demo/roles-dialog',["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-event-aggregator", "../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_dialog_1, aurelia_event_aggregator_1, web_api_users_1) {
    ...
    var RolesDialog = (function () {
        ...
        RolesDialog.prototype.no = function () {
            this.controller.cancel();
        };
        return RolesDialog;
    }());
...
define('user-info/user-info.1',["require", "exports", "aurelia-framework", "aurelia-framework", "aurelia-event-aggregator", "../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_framework_2, aurelia_event_aggregator_1, web_api_users_1) {
    "use strict";
    var UserInfo = (function () {
        function UserInfo(api, ea) {
            var _this = this;
...
define('text!dialog-demo/info-dialog.1.html', ['module'], function(module) { module.exports = "<template>\r\n    <ai-dialog>\r\n        <ai-dialog-header>\r\n                <h2>Edit User</h2>\r\n        </ai-dialog-header>  \r\n\r\n        <ai-dialog-body>\r\n            <div class=\"text-center\">\r\n                <div class=\"row\">\r\n                    <strong>First Name: </strong> ${info.firstName}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>Last Name: </strong> ${info.lastName}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>Email: </strong> ${info.email}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>City: </strong> ${info.city}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>Country: </strong> ${info.country}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <h4>Is this information correct?</h4>\r\n                </div>\r\n            </div>        \r\n        </ai-dialog-body>\r\n        \r\n        <ai-dialog-footer>\r\n                <button class=\"btn btn-primary\" click.trigger=\"yes()\">Yes</button>\r\n                <button class=\"btn btn-primary\" click.trigger=\"no()\">No</button>\r\n        </ai-dialog-footer>    \r\n    </ai-dialog>\r\n</template>"; });
define('text!dialog-demo/roles-dialog.html', ['module'], function(module) { module.exports = "<template>\r\n    <ai-dialog>\r\n        <ai-dialog-header>\r\n            <h2>${title}</h2>\r\n        </ai-dialog-header>\r\n\r\n        <ai-dialog-body>\r\n            <div class=\"text-center\">\r\n                <div class=\"row\">\r\n                    <strong>ID: </strong> ${userRole.id}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>Name: </strong>${userRole.first_name} ${userRole.last_name}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>MRT Member: </strong> ${userRole.mrt_member}\r\n                </div>\r\n                <div class=\"row\">\r\n                    <strong>System Role: </strong> ${userRole.mrt_system_role}\r\n                </div>\r\n            </div>\r\n        </ai-dialog-body>\r\n\r\n        <ai-dialog-footer>\r\n            <button class=\"btn btn-primary\" click.trigger=\"yes()\">Yes</button>\r\n            <button class=\"btn btn-default pull-left\" click.trigger=\"no()\">No</button>\r\n        </ai-dialog-footer>\r\n    </ai-dialog>\r\n</template>"; });
