...
define('api/web-api-users',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "aurelia-router", "jquery"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, aurelia_router_1) {
    "use strict";
    var latency = 200;
    var id = 0;
    var users = null;
    ...
    var WebAPIUsers = (function () {
        ...
        WebAPIUsers.prototype.apiCall = function (getId, getData) {
            ...
            if (!hw_useJson && getData && apiUrlsArr[getId].urlApurlAppendEndpend)
                apiUrl += apiUrlsArr[getId].urlAppendEnd;
...
define('app',["require", "exports", "aurelia-router", "aurelia-framework", "./resources/constants", "aurelia-auth", "aurelia-http-client", "./api/web-api-users"], function (require, exports, aurelia_router_1, aurelia_framework_1, Constants, aurelia_auth_1, aurelia_http_client_1, web_api_users_1) {
    "use strict";
    var CV = Constants;
...
define('dialog-demo/delete-user-dialog',["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-event-aggregator", "../api/web-api-users", "../resources/lookups"], function (require, exports, aurelia_framework_1, aurelia_dialog_1, aurelia_event_aggregator_1, web_api_users_1, lookups_1) {
    ...
    var DeleteDialog = (function () {
        function DeleteDialog(controller, api, ea, model, lookups) {
            ...
            this.api.apiCall('user-role', this.userSelectedId).then(function (user) {
                _this.userRole = user;
            });
            this.systemRoles = lookups.systemRoles;
        }
        ...
        DeleteDialog.prototype.triggerDelete = function () {
            var _this = this;
            this.api.deleteUser(this.userSelectedId).then(function () {
...
define('views/pages/welcome',["require", "exports", "aurelia-framework", "aurelia-router", "../../resources/constants", "../../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_router_1, Constants, web_api_users_1) {
    "use strict";
    var CV = Constants;
    var Welcome = (function () {
        function Welcome(api, router) {
            this.api = api;
            this.CV = CV;
    ...
    Welcome = __decorate([
        aurelia_framework_1.inject(web_api_users_1.WebAPIUsers, aurelia_router_1.Router),
...
define('views/ui/nav-bar',["require", "exports", "aurelia-framework", "../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    var NavBar = (function () {
        ...
        NavBar.prototype.hasAccess = function (getUser, getPage) {
            console.log('hasAccess: ' + JSON.stringify(getUser) + ' / ' + getPage.settings);
            if (!getUser)
                return false;
            if (getPage.settings && (!getUser.isEditor && getPage.settings.isEditorOnly))
                return false;
            return true;
        };
...
define('views/widgets/form-user-full-body',["require", "exports", "aurelia-framework", "../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], FormUserFullBody.prototype, "myLookups", void 0);
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
...
define('views/widgets/user-list',["require", "exports", "aurelia-event-aggregator", "aurelia-router", "../../api/web-api-users", "aurelia-framework", "../../resources/constants", "aurelia-dialog", "../../user-info/user-info", "../../dialog-demo/roles-dialog", "../../dialog-demo/add-user-dialog", "../../dialog-demo/delete-user-dialog", "../../resources/lookups"], function (require, exports, aurelia_event_aggregator_1, aurelia_router_1, web_api_users_1, aurelia_framework_1, Constants, aurelia_dialog_1, user_info_1, roles_dialog_1, add_user_dialog_1, delete_user_dialog_1, lookups_1) {
    ...
    var UserList = (function () {
        ...
        UserList.prototype.created = function (lookups) {
            if (CV.debugConsoleLog)
...
define('views/widgets/inputs/form-checkbox',["require", "exports", "aurelia-framework", "../../../resources/constants", "aurelia-binding"], function (require, exports, aurelia_framework_1, Constants, aurelia_binding_1) {
    ...
    var FormCheckbox = (function () {
        ...
        FormCheckbox.prototype.created = function () {
            ...
            if (!this.inpLabel)
                this.inpLabel = CV.myLabels[this.custName] ? CV.myLabels[this.custName] : this.custName;
...
define('views/widgets/inputs/form-select',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    var FormSelect = (function () {
        ...
        FormSelect.prototype.created = function () {
            ...
            if (!this.inpLabel)
                this.inpLabel = CV.myLabels[this.custName] ? CV.myLabels[this.custName] : '______________' + this.custName;
            if (!this.inpPlaceholder)
                this.inpPlaceholder = "> Select " + this.inpLabel + " <";
        };
...
define('views/widgets/user-panels/user-panel-confidential',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelConfidential.prototype, "myLookups", void 0);
...
define('views/widgets/user-panels/user-panel-details',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelDetails.prototype, "myLookups", void 0);
...
define('views/widgets/user-panels/user-panel-languages',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelLanguages = (function () {
        function UserPanelLanguages() {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelLanguages.prototype, "myLookups", void 0);
...
define('views/widgets/user-panels/user-panel-passport',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelPassport = (function () {
        function UserPanelPassport() {
            this.isReadOnly = null;
        }
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelPassport.prototype, "myLookups", void 0);
...
define('views/widgets/user-panels/user-panel-training',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelTraining.prototype, "myLookups", void 0);
...
define('views/widgets/user-panels/user-panel-visa',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelVisa = (function () {
        function UserPanelVisa() {
            this.isReadOnly = null;
        }
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelVisa.prototype, "myLookups", void 0);
