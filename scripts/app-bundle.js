...
define('app',["require", "exports", "aurelia-framework", "./api/web-api", "./resources/constants"], function (require, exports, aurelia_framework_1, web_api_1, Constants) {
    "use strict";
    var CV = Constants;
    var App = (function () {
        function App(api) {
        ...
        WebAPIUsers.prototype.getUserDetails = function (id) {
            ...
            return new Promise(function (resolve) {
                setTimeout(function () {
                    ...
                    var found = _this.http.fetch('src/views/widgets/user-panels/dummy-user.json')
...
define('dialog-demo/add-user-dialog',["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-event-aggregator", "../api/web-api-users", "../resources/lookups"], function (require, exports, aurelia_framework_1, aurelia_dialog_1, aurelia_event_aggregator_1, web_api_users_1, lookups_1) {
    ...
    AddUserDialog = __decorate([
        aurelia_framework_1.autoinject,
        aurelia_framework_1.inject(aurelia_dialog_1.DialogController, web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator),
    ...
    var UserInfo = (function () {
        function UserInfo(api, ea) {
            ...
            this.api.getUserRole(6).then(function (user) {
                _this.info = user;
                _this.first_name = _this.info.first_name;
            });
        }
    ...
    var UserSelected = (function () {
        ...
        UserSelected.prototype.activate = function (params, routeConfig) {
            ...
            return this.api.getUserDetails(params.id).then(function (user) {
                ...
                _this.user = user;
                _this.routeConfig.navModel.setTitle(_this.user.first_name);
                _this.originalUser = JSON.parse(JSON.stringify(_this.user));
...
define('views/widgets/user-list',["require", "exports", "aurelia-event-aggregator", "../../api/web-api-users", "../../resources/messages", "aurelia-framework", "aurelia-framework", "../../resources/constants", "aurelia-dialog", "../../user-info/user-info", "../../dialog-demo/roles-dialog", "../../dialog-demo/add-user-dialog", "../../resources/lookups"], function (require, exports, aurelia_event_aggregator_1, web_api_users_1, messages_1, aurelia_framework_1, aurelia_framework_2, Constants, aurelia_dialog_1, user_info_1, roles_dialog_1, add_user_dialog_1, lookups_1) {
    "use strict";
    var CV = Constants;
    var UserList = (function () {
        function UserList(api, ea, userInfo, dialogService, lookups) {
            var _this = this;
            this.api = api;
            this.userInfo = userInfo;
            this.dialogService = dialogService;
            this.custHideTitleBar = false;
            this.custClickableRow = false;
            this.CV = CV;
            this.selectedId = 0;
            this.title = 'Users';
        ...
        UserList.prototype.returnLabelFromValue = function (getId) {
            if (getId)
                return this.rolesArr.filter(function (x) { return x.value == getId; })[0].label;
            return '';
        };
        UserList.prototype.populateRoleFilterFromList = function () {
            ...
            var _loop_1 = function (next) {
                var nextRole = next.mrt_system_role;
                if (nextRole && tmp_rolesArrValues.indexOf(nextRole) === -1) {
                    tmp_rolesArrValues.push(nextRole);
                    var nextLabel = this_1.rolesArr.filter(function (x) { return x.value == nextRole; })[0].label;
                    this_1.rolesArrDynamic.push({ "value": nextRole, "label": nextLabel });
                }
            };
            var this_1 = this;
    ...
    __decorate([
        aurelia_framework_2.bindable,
        __metadata("design:type", Object)
    ], UserList.prototype, "custClickableRowFunction", void 0);
    __decorate([
        aurelia_framework_2.bindable,
        __metadata("design:type", Object)
    ], UserList.prototype, "custClickableRow", void 0);
    UserList = __decorate([
        aurelia_framework_1.autoinject,
        aurelia_framework_1.inject(web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, aurelia_dialog_1.DialogService, lookups_1.Lookups),
        __metadata("design:paramtypes", [web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, user_info_1.UserInfo, aurelia_dialog_1.DialogService, lookups_1.Lookups])
    ], UserList);
...
define('views/widgets/inputs/form-input',["require", "exports", "aurelia-framework", "../../../resources/constants", "aurelia-binding"], function (require, exports, aurelia_framework_1, Constants, aurelia_binding_1) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], FormInput.prototype, "inpClass", void 0);
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
...
define('views/widgets/inputs/form-select',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], FormSelect.prototype, "inpClass", void 0);
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], FormSelect.prototype, "inpPlacement", void 0);
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
...
define('views/widgets/user-panels/user-panel-mrt',["require", "exports", "aurelia-framework", "../../../resources/lookups"], function (require, exports, aurelia_framework_1, lookups_1) {
    "use strict";
    var UserPanelMrt = (function () {
        function UserPanelMrt(lookups) {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelMrt.prototype, "user", void 0);
    UserPanelMrt = __decorate([
        aurelia_framework_1.autoinject,
        __metadata("design:paramtypes", [lookups_1.Lookups])
    ], UserPanelMrt);
    exports.UserPanelMrt = UserPanelMrt;
});
...
define('views/widgets/user-panels/user-panel-passport-visa',["require", "exports", "aurelia-framework", "../../../resources/lookups"], function (require, exports, aurelia_framework_1, lookups_1) {
    "use strict";
    var UserPanelPassportVisa = (function () {
        function UserPanelPassportVisa(lookups) {
            this.lookups = lookups;
        ...
        return UserPanelPassportVisa;
    }());
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], UserPanelPassportVisa.prototype, "user", void 0);
    UserPanelPassportVisa = __decorate([
        aurelia_framework_1.autoinject,
        __metadata("design:paramtypes", [lookups_1.Lookups])
    ], UserPanelPassportVisa);
    exports.UserPanelPassportVisa = UserPanelPassportVisa;
});
...
define('text!views/widgets/inputs/form-select.html', ['module'], function(module) { module.exports = "<template class=\"form-group ${inputOnly ? '' : 'col-xs-12'} ${inpClass} ${isMandatory ? 'is-mandatory' : ''}\">\r\n    \r\n    <require from=\"../filter\"></require>\r\n    <require from=\"../../../resources/select2\"></require>\r\n    <require from=\"select2/css/select2.min.css\"></require>\r\n\r\n    <div class=\"${inputOnly ? '' : 'rowXXX'}\">\r\n        <label if.bind=\"!inputOnly\" class=\"col-sm-6\" for.bind=\"name\" title.bind=\"inpLabel\">${inpLabel}</label>\r\n        <!--/ ${changed} / ${initSelected} / ${selected}-->\r\n        <div class=\"${inputOnly ? '' : 'col-sm-6'}\">\r\n            <!--selected.two-way=\"selected\" -->\r\n            <!--| ${model} | ${selected} | ${changed} | ${initSelected}-->\r\n\r\n\r\n            <select if.bind=\"!autocomplete\" class=\"form-control\" value.bind=\"initSelected\" disabled.bind=\"!isEnabled\" selected.two-way=\"selected\"\r\n                change.delegate=\"changeCallback($event)\">\r\n                <option value=\"\">${inpPlaceholder}</option>                 \r\n                <option repeat.for=\"option of options | filter:'parentValue':optionFilter\" model.bind=\"option.value\">${option.label}</option>\r\n            </select>\r\n\r\n            <select if.bind=\"autocomplete\" class=\"form-control\" id.bind=\"name\" select2.bind=\"selectOptions\" value.bind=\"initSelected\"\r\n                disabled.bind=\"!isEnabled\" change.delegate=\"changeCallback($event)\">\r\n                \r\n                <option value=\"\">${inpPlaceholder}</option>\r\n                <option repeat.for=\"option of options | filter:'parentValue':optionFilter\" model.bind=\"option.value\">\r\n                    ${option.label}\r\n                </option>\r\n            </select>\r\n\r\n        </div>\r\n    </div>\r\n</template>"; });
define('text!views/widgets/user-panels/user-panel-details.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"../inputs/form-input\"></require>\r\n    <require from=\"../inputs/form-select\"></require>\r\n    <require from=\"../filter\"></require>\r\n    <require from=\"../../../resources/constants\"></require>\r\n    <require from=\"../../../resources/select2\"></require>\r\n\r\n    <form-input name=\"first_name\" model.two-way=\"user.first_name\" is-mandatory=\"true\"></form-input>\r\n    <form-input name=\"last_name\" model.two-way=\"user.last_name\" is-mandatory=\"true\"></form-input>\r\n\r\n    <div class=\"divider\"></div>\r\n    <div class=\"col-xs-12\" if.bind=\"CV.debugShowOutput\">? DEV NOTE: SELECT [1,3,8,9] ... SELECTED: ${user.first_name}: ${user.lkp_region_selected} > ${user.lkp_hub_selected} > ${user.lkp_segment_selected} > ${user.lkp_entity_selected} ?</div>\r\n    \r\n    <form-select name=\"lkp_region\"\r\n        model.two-way=\"user.lkp_region_selected\"\r\n        options.bind=\"lkp_region\"\r\n        changed.two-way=\"user.lkp_region_selected\"\r\n        autocomplete.bind=\"true\"\r\n        init-selected.two-way=\"user.lkp_region_selected\"></form-select>\r\n\r\n    <form-select name=\"lkp_hub\"\r\n        model.two-way=\"user.lkp_hub_selected\"\r\n        options.bind=\"lkp_hub\"\r\n        changed.two-way=\"user.lkp_hub_selected\"        \r\n        init-selected.two-way=\"user.lkp_hub_selected\"\r\n        option-filter.bind=\"user.lkp_region_selected\"\r\n        autocomplete.bind=\"true\"\r\n        is-enabled.bind=\"user.lkp_region_selected\"></form-select>\r\n\r\n    <form-select name=\"lkp_segment\"\r\n        model.two-way=\"user.lkp_segment_selected\"\r\n        options.bind=\"lkp_segment\"\r\n        changed.two-way=\"user.lkp_segment_selected\"        \r\n        init-selected.two-way=\"user.lkp_segment_selected\"\r\n        option-filter.bind=\"user.lkp_hub_selected\"\r\n        autocomplete.bind=\"true\"\r\n        is-enabled.bind=\"user.lkp_region_selected && user.lkp_hub_selected\"></form-select>\r\n\r\n    <form-select name=\"lkp_entity\"\r\n        model.two-way=\"user.lkp_entity_selected\"\r\n        options.bind=\"lkp_entity\"\r\n        changed.two-way=\"user.lkp_entity_selected\"        \r\n        init-selected.two-way=\"user.lkp_entity_selected\"\r\n        option-filter.bind=\"user.lkp_segment_selected\"\r\n        autocomplete.bind=\"true\"\r\n        is-enabled.bind=\"user.lkp_region_selected && user.lkp_hub_selected && user.lkp_segment_selected\"></form-select>\r\n\r\n    \r\n    <div class=\"divider\"></div>\r\n\r\n    <form-input name=\"function\" model.two-way=\"user.function\" inp-name=\"testMe\"></form-input>\r\n    <form-input name=\"location\" model.two-way=\"user.location\"></form-input>\r\n    <form-input name=\"email\" model.two-way=\"user.email\" is-mandatory=\"true\"></form-input>\r\n\r\n    \r\n    <!--<form-input name=\"cell_number\" model.two-way=\"user.cell_number\" mask-pattern=\"telephone\"></form-input>\r\n    <form-input name=\"office_number\" model.two-way=\"user.office_number\" mask-pattern=\"telephone\"></form-input>-->\r\n\r\n    <div class=\"divider\"></div>\r\n    <form-select name=\"lkp_bp_office_address\"\r\n        model.two-way=\"user.lkp_bp_office_address_selected\"\r\n        options.bind=\"lkp_bp_office_address\"\r\n        changed.two-way=\"user.lkp_bp_office_address_selected\"\r\n        autocomplete.bind=\"true\"\r\n        init-selected.two-way=\"user.lkp_bp_office_address_selected\"></form-select>\r\n\r\n    <form-input name=\"cell_number\" model.two-way=\"user.cell_number\" is-mandatory=\"true\" mask-pattern=\"telephone\"></form-input>\r\n    <form-input name=\"office_number\" model.two-way=\"user.office_number\" mask-pattern=\"telephone\"></form-input>\r\n    <form-input name=\"home_number\" model.two-way=\"user.home_number\" mask-pattern=\"telephone\"></form-input>\r\n\r\n    <div class=\"divider\"></div>\r\n\r\n    <form-input name=\"line_manager\" model.two-way=\"user.line_manager\"></form-input>\r\n    <form-input name=\"line_manager_email\" model.two-way=\"user.line_manager_email\"></form-input>\r\n\r\n    <div class=\"divider\"></div>\r\n\r\n    <form-input name=\"emergency_contact_name\" model.two-way=\"user.emergency_contact_name\"></form-input>\r\n    <form-input name=\"emergency_contact_number\" model.two-way=\"user.emergency_contact_number\" mask-pattern=\"telephone\"></form-input>\r\n\r\n</template>"; });
define('text!views/widgets/user-panels/user-panel-mrt-role.html', ['module'], function(module) { module.exports = "<template>\r\n    \r\n    <require from=\"../inputs/form-input\"></require>\r\n    <require from=\"../inputs/form-select\"></require>\r\n\r\n    <form-select name=\"lkp_mrt_1_ics\"\r\n        model.two-way=\"user.lkp_mrt_1_ics_selected\"\r\n        options.bind=\"lkp_mrt_1_ics\"\r\n        changed.two-way=\"user.lkp_mrt_1_ics_selected\"\r\n        init-selected.two-way=\"user.lkp_mrt_1_ics_selected\"></form-select>\r\n\r\n    <form-select name=\"lkp_mrt_2_ics\"\r\n        model.two-way=\"user.lkp_mrt_2_ics_selected\"\r\n        options.bind=\"lkp_mrt_2_ics\"\r\n        changed.two-way=\"user.lkp_mrt_2_ics_selected\"\r\n        init-selected.two-way=\"user.lkp_mrt_2_ics_selected\"></form-select>\r\n\r\n    <form-input name=\"previous_role\" model.two-way=\"user.previous_role\"></form-input>\r\n\r\n</template>"; });
define('text!views/widgets/user-panels/user-panel-mrt.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"../inputs/form-input\"></require>\r\n    <require from=\"../inputs/form-select\"></require>\r\n    <require from=\"../../../resources/format/format-date\"></require>\r\n\r\n    <form-select name=\"lkp_member_status\"\r\n        model.two-way=\"user.lkp_member_status_selected\"\r\n        options.bind=\"lkp_member_status\"\r\n        changed.two-way=\"user.lkp_member_status_selected\"\r\n        autocomplete.bind=\"true\"\r\n        init-selected.two-way=\"user.lkp_member_status_selected\"></form-select>\r\n\r\n    <form-input name=\"date_joined\" model.two-way=\"user.date_joined\" inp-type=\"date\"></form-input>\r\n    \r\n    <div class=\"divider\"></div>\r\n\r\n    <form-select name=\"lkp_vest_colour\"\r\n        model.two-way=\"user.lkp_vest_colour_selected\"\r\n        options.bind=\"lkp_vest_colour\"\r\n        changed.two-way=\"user.lkp_vest_colour_selected\"\r\n        autocomplete.bind=\"true\"\r\n        init-selected.two-way=\"user.lkp_vest_colour_selected\"></form-select>\r\n\r\n    <form-input name=\"coat_size\" model.two-way=\"user.coat_size\"></form-input>\r\n\r\n    <div class=\"divider\"></div>\r\n\r\n    <div class=\"repeaters row-fluid\" repeat.for=\"row of user.lkp_languages_selected_arr\">\r\n        \r\n        <div if.bind=\"$index>0\" class=\"divider dotted\"></div>\r\n\r\n        <form-select name=\"lkp_language[$index]\" inp-label=\"Language\"\r\n            model.two-way=\"user.lkp_languages_selected_arr[$index].languageId\"\r\n            options.bind=\"lkp_languages\"\r\n            changed.two-way=\"user.lkp_languages_selected_arr[$index].languageId\"\r\n            autocomplete.bind=\"true\"\r\n            init-selected.two-way=\"user.lkp_languages_selected_arr[$index].languageId\"></form-select>\r\n\r\n        <form-select name=\"lkp_languageLevel[$index]\" inp-label=\"Language Level\"\r\n            model.two-way=\"user.lkp_languages_selected_arr[$index].languageLevelId\"\r\n            options.bind=\"lkp_languageLevel\"\r\n            changed.two-way=\"user.lkp_languages_selected_arr[$index].languageLevelId\"\r\n            autocomplete.bind=\"false\"\r\n            init-selected.two-way=\"user.lkp_languages_selected_arr[$index].languageLevelId\"></form-select>\r\n\r\n        <div class=\"col-xs-12 margin-bottom-g1\">\r\n            <button class=\"btn btn-default btn-sm\" if.bind=\"$index+1 == user.lkp_languages_selected_arr.length && $index+1<lkp_languages_limitTo\">\r\n                <i class=\"fa fa-plus\"></i>\r\n                Add Language\r\n            </button>\r\n        </div>\r\n\r\n               \r\n\r\n    </div>\r\n\r\n</template>"; });
define('text!views/widgets/user-panels/user-panel-passport-visa.html', ['module'], function(module) { module.exports = "<template>\r\n\r\n    <require from=\"../inputs/form-input\"></require>\r\n    <require from=\"../inputs/form-select\"></require>\r\n\r\n\r\n    <div class=\"repeaters row-fluid\" repeat.for=\"row of user.lkp_passports_selected_arr\">\r\n\r\n        <div if.bind=\"$index>0\" class=\"divider dotted\"></div>\r\n\r\n        <form-select name=\"lkp_passport_type[$index]\" inp-label=\"Passport Type\"\r\n            model.two-way=\"user.lkp_passports_selected_arr[$index].typeId\"\r\n            options.bind=\"lkp_passport_type\"\r\n            changed.two-way=\"user.lkp_passports_selected_arr[$index].typeId\"\r\n            autocomplete.bind=\"true\"\r\n            init-selected.two-way=\"user.lkp_passports_selected_arr[$index].typeId\"></form-select>\r\n\r\n        <form-input name=\"passport_number\" model.two-way=\"user.lkp_passports_selected_arr[$index].number\"></form-input>\r\n\r\n        <form-select name=\"lkp_passport_nationality[$index]\" inp-label=\"Nationality\"\r\n            model.two-way=\"user.lkp_passports_selected_arr[$index].nationalityId\"\r\n            options.bind=\"lkp_passport_nationality\"\r\n            changed.two-way=\"user.lkp_passports_selected_arr[$index].nationalityId\"\r\n            autocomplete.bind=\"true\"\r\n            init-selected.two-way=\"user.lkp_passports_selected_arr[$index].nationalityId\"></form-select>\r\n\r\n        <form-input name=\"passport_expiry_date\" model.two-way=\"user.lkp_passports_selected_arr[$index].expiryDate\"></form-input>\r\n\r\n        <div class=\"btn-row text-align-left\">\r\n            <button class=\"btn btn-default btn-sm btn-i\" if.bind=\"$index+1 == user.lkp_passports_selected_arr.length\">\r\n                <i class=\"fa fa-plus\"></i>\r\n                Add Passport\r\n            </button>\r\n        </div>\r\n\r\n    </div>\r\n\r\n    <div class=\"divider\"></div>\r\n\r\n    <div class=\"repeaters row-fluid\" repeat.for=\"row of user.lkp_passports_selected_arr\">\r\n\r\n        <div if.bind=\"$index>0\" class=\"divider dotted\"></div>\r\n\r\n        <form-select name=\"lkp_visa_country[$index]\" inp-label=\"Visa Country\"\r\n            model.two-way=\"user.lkp_visas_selected_arr[$index].countryId\"\r\n            options.bind=\"lkp_visa_country\"\r\n            changed.two-way=\"user.lkp_visas_selected_arr[$index].countryId\"\r\n            autocomplete.bind=\"true\"\r\n            init-selected.two-way=\"user.lkp_visas_selected_arr[$index].countryId\"></form-select>\r\n\r\n        <form-input name=\"visa_expiry_date\" model.two-way=\"user.lkp_visas_selected_arr[$index].expiryDate\"></form-input>\r\n\r\n        <form-select name=\"lkp_visa_type[$index]\" inp-label=\"Visa Type\"\r\n            model.two-way=\"user.lkp_visas_selected_arr[$index].typeId\"\r\n            options.bind=\"lkp_passport_nationality\"\r\n            changed.two-way=\"user.lkp_visas_selected_arr[$index].typeId\"\r\n            autocomplete.bind=\"true\"\r\n            init-selected.two-way=\"user.lkp_visas_selected_arr[$index].typeId\"></form-select>        \r\n\r\n        <div class=\"btn-row text-align-left\">\r\n            <button class=\"btn btn-default btn-sm btn-i\" if.bind=\"$index+1 == user.lkp_visas_selected_arr.length\">\r\n                <i class=\"fa fa-plus\"></i>\r\n                Add Visa\r\n            </button>\r\n        </div>\r\n\r\n    </div>\r\n\r\n\r\n</template>"; });
