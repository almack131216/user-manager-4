...
define('app',["require", "exports", "aurelia-router", "aurelia-framework", "./resources/constants", "aurelia-auth", "aurelia-http-client", "./api/web-api-users", "./my-globals"], function (require, exports, aurelia_router_1, aurelia_framework_1, Constants, aurelia_auth_1, aurelia_http_client_1, web_api_users_1, my_globals_1) {
    "use strict";
    var CV = Constants;
...
define('views/pages/user-add',["require", "exports", "aurelia-framework", "aurelia-fetch-client", "aurelia-event-aggregator", "../../api/web-api-users", "../../resources/constants", "../../my-globals", "../../my-nav", "toastr"], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, aurelia_event_aggregator_1, web_api_users_1, Constants, my_globals_1, my_nav_1, toastr) {
    ...
    var UserAdd = (function () {
        ...
        UserAdd.prototype.testToastr = function () {
    ...
    UserAdd = __decorate([
        aurelia_framework_1.autoinject,
        __metadata("design:paramtypes", [web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, aurelia_fetch_client_1.HttpClient, my_globals_1.MyGlobals, my_nav_1.MyNav, Object])
    ], UserAdd);
...
define('views/widgets/user-panels/user-panel-languages',["require", "exports", "aurelia-framework", "../../../my-globals", "../../../resources/constants"], function (require, exports, aurelia_framework_1, my_globals_1, Constants) {
    "use strict";
    var CV = Constants;
