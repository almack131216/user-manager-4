...
define('api/web-api-users',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "aurelia-router", "jquery"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, aurelia_router_1) {
    ...
    var WebAPIUsers = (function () {
        ...
        WebAPIUsers.prototype.apiCall = function (getId, getData) {
            ...
            if (!hw_useJson && getData && apiUrlsArr[getId].urlAppendEnd)
                apiUrl += apiUrlsArr[getId].urlAppendEnd;
            if (hw_useJson && getData && apiUrlsArr[getId].urlLocalAppendEnd)
                apiUrl += apiUrlsArr[getId].urlLocalAppendEnd;
...
define('views/pages/user-add',["require", "exports", "aurelia-framework", "aurelia-fetch-client", "aurelia-event-aggregator", "../../api/web-api-users", "aurelia-framework", "aurelia-router", "../../resources/constants"], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, aurelia_event_aggregator_1, web_api_users_1, aurelia_framework_2, aurelia_router_1, Constants) {
    ...
    var UserAdd = (function () {
        ...
        UserAdd.prototype.navigateToEditThisPage = function (getId) {
    ...
    UserAdd = __decorate([
        ...
        __metadata("design:paramtypes", [web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, aurelia_fetch_client_1.HttpClient, aurelia_router_1.Router])
    ], UserAdd);
