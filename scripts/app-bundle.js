...
define('dialog-demo/add-user-dialog',["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-event-aggregator", "../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_dialog_1, aurelia_event_aggregator_1, web_api_users_1) {
    "use strict";
    var AddUserDialog = (function () {
        function AddUserDialog(controller, api, ea) {
        ...
        AddUserDialog.prototype.select = function (getId) {
            var _this = this;
            this.api.getUserDetails(getId).then(function (user) {
                _this.userRole = user;
                _this.selectedId = _this.userRole.id;
                _this.lkp_mrt_system_role = [
    ...
    AddUserDialog = __decorate([
        ...
        __metadata("design:paramtypes", [aurelia_dialog_1.DialogController, web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator])
    ], AddUserDialog);
...
define('dialog-demo/roles-dialog',["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-event-aggregator", "../api/web-api-users"], function (require, exports, aurelia_framework_1, aurelia_dialog_1, aurelia_event_aggregator_1, web_api_users_1) {
    "use strict";
    var RolesDialog = (function () {
        function RolesDialog(controller, api, ea, model) {
            var _this = this;
            this.controller = controller;
            this.api = api;
            this.ea = ea;
    ...
    RolesDialog = __decorate([
        aurelia_framework_1.inject(aurelia_dialog_1.DialogController, web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator),
        __metadata("design:paramtypes", [aurelia_dialog_1.DialogController, web_api_users_1.WebAPIUsers, aurelia_event_aggregator_1.EventAggregator, Object])
    ], RolesDialog);
...
define('views/widgets/user-list',["require", "exports", "aurelia-event-aggregator", "../../api/web-api-users", "../../resources/messages", "aurelia-framework", "aurelia-framework", "../../resources/constants", "aurelia-dialog", "../../user-info/user-info", "../../dialog-demo/roles-dialog", "../../dialog-demo/add-user-dialog", "../../resources/lookups"], function (require, exports, aurelia_event_aggregator_1, web_api_users_1, messages_1, aurelia_framework_1, aurelia_framework_2, Constants, aurelia_dialog_1, user_info_1, roles_dialog_1, add_user_dialog_1, lookups_1) {
    ...
    var UserList = (function () {
        function UserList(api, ea, userInfo, dialogService, lookups) {
            ...
            this.rolesArr = this.lkp_Roles.map(function (x) {
                return {
                    value: x.id,
                    label: x.label
                };
...
define('views/widgets/user-panels/user-panel-details',["require", "exports", "aurelia-framework", "../../../resources/constants"], function (require, exports, aurelia_framework_1, Constants) {
    "use strict";
    var CV = Constants;
...
define('views/widgets/user-panels/user-panel-mrt-role',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelMrtRole = (function () {
        function UserPanelMrtRole() {
            this.lkp_mrt_1_ics = [
...
define('views/widgets/user-panels/user-panel-mrt',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelMrt = (function () {
        function UserPanelMrt() {
...
define('views/widgets/user-panels/user-panel-passport-visa',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var UserPanelPassportVisa = (function () {
        function UserPanelPassportVisa() {
